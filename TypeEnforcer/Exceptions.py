class TypeEnforcerBaseException(Exception):
...
class InvalidTypeError(TypeEnforcerBaseException):
    """
...
class MismatchedTypeError(TypeEnforcerBaseException):
    """
    a = [int, int, int]
    =>
    b = [int, float, int]
...
class NonUnionizedTypeError(TypeEnforcerBaseException):
    """
...
class NestedGenericError(TypeEnforcerBaseException):
    """
